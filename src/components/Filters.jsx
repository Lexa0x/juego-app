...
const Filters = ({ onApplyFilters }) => {
  ...
  const handleApplyFilters = () => {
    ...
    if (year) {
      validFilters.dates = `${year}-01-01,${year}-12-31`;
    }

    if (genre) {
      validFilters.genres = genre;
    }

    if (platform) {
      validFilters.platforms = platform;
    }

    if (developer) {
      validFilters.developers = developer;
    }

    if (tag) {
      validFilters.tags = tag;
    }
